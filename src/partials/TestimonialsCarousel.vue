    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      <div class="py-12 md:py-20">
        ...
        <div class="max-w-3xl mx-auto text-center pb-12 md:pb-16">
          <h2 class="h2 mb-4" data-aos="zoom-y-out">Testimonios reales de MotorDeal</h2>
          <p class="text-xl text-gray-600">Escucha las historias de personas reales que confían en MotorDeal.</p>
        </div>
        ...
        <div class="max-w-3xl mx-auto">
          ...
          <div class="relative mt-20" data-aos="zoom-y-out">
            ...
            <!-- Testimonials -->
            <transition-group tag="div" class="relative flex items-start border-2 border-gray-200 rounded bg-white z-10" enter-active-class="transition ease-in-out duration-700 transform order-first" enter-from-class="opacity-0 -translate-y-8" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in-out duration-300 transform absolute" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-8">
              <template v-for="(item, index) in items" :key="index">
                ...
                >
                  <div class="absolute top-0 -mt-8 left-1/2 transform -translate-x-1/2">
                    ...
                    <img class="relative rounded-full" :src="item.img" width="96" height="96" :alt="item.alt" />
                  </div>
            ...
            <div class="absolute inset-0 flex items-center justify-between">
              <button class="relative z-20 w-16 h-16 p-1 flex items-center justify-center bg-white rounded-full border border-gray-200 shadow-md hover:shadow-lg transform -translate-x-2 md:-translate-x-1/2" @click="active = active === 0 ? items.length - 1 : active - 1; stopAutorotate();">
                <span class="sr-only">Anterior</span>
                <svg class="w-4 h-4 fill-current text-gray-500" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6.7 14.7l1.4-1.4L3.8 9H16V7H3.8l4.3-4.3-1.4-1.4L0 8z" />
                </svg>
              </button>
              <button class="relative z-20 w-16 h-16 p-1 flex items-center justify-center bg-white rounded-full border border-gray-200 shadow-md hover:shadow-lg transform translate-x-2 md:translate-x-1/2" @click="active = active === items.length - 1 ? 0 : active + 1; stopAutorotate();">
...
<script>
import Image01 from '../images/arribas.png'
import Image02 from '../images/clement.jpg'
import Image03 from '../images/marina.png'
  ...
  data: function () {
    return {
      ...
      items: [
      {
          ...
          alt: 'Testimonial 01',
          quote:
            '“ Javier Arribas se dedica al karate, pero siempre confía en MotorDeal para encontrar vehículos a su medida. “',
          name: 'Javier Arribas',
          role: 'Cliente',
          team: '@MotorDeal',
          link: '#0'
        },
        {
          ...
          alt: 'Testimonial 02',
          quote:
            '“ Como profesional de windsurf, Javier Clement siempre está en movimiento. Gracias a MotorDeal, puede encontrar y vender vehículos fácilmente. “',
          name: 'Javier Clement',
          role: 'Cliente',
          team: '@MotorDeal',
          link: '#0'
        },
        {
          ...
          alt: 'Testimonial 03',
          quote:
            '“ Gracias a MotorDeal, pude vender mi coche rápidamente y utilizar el dinero para pagar un tratamiento contra mi alcoholismo que cambió mi vida. Ahora estoy en un camino nuevo y lleno de esperanza. “',
