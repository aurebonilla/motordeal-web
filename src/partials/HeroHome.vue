    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div class="pt-32 pb-12 md:pt-40 md:pb-20">
        ...
        <div class="text-center pb-12 md:pb-16">
          <h1 class="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">Busca, compra y vende con <span class="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400">MotorDeal</span></h1>
          <div class="max-w-3xl mx-auto">
            <p class="text-xl text-gray-600 mb-8" data-aos="zoom-y-out" data-aos-delay="150">Descubre aquí todo sobre el sistema y en que te podemos ayudar.</p>
